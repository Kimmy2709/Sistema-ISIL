...
public class FileSystemStorageService implements StorageService{
    ...
    public String store(MultipartFile file) {
        ...
        if(file.isEmpty()){
            throw new StorageException("Error al guardar un archivo vacpio" + filename);
        }
        try{
    ...
    @Override
    public Resource loadAsResource(String filename) throws FileNotFoundException { //resource es tdo lo que puede ser transferido o caragado en la web, videos, archivos, html, css, json
        try{
